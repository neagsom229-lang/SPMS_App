...
Write-Host "🔧 Fixing ALL routes with tenant_id filter..." -ForegroundColor Cyan
...
# 1. PRODUCTS ROUTE
# ============================================
Write-Host "📝 Fixing products.js..." -ForegroundColor Yellow
...
"@ | Out-File -FilePath "$routePath/products.js" -Encoding utf8

Write-Host "✅ products.js fixed" -ForegroundColor Green

# ============================================
# 2. ORDERS ROUTE
# ============================================
Write-Host "📝 Fixing orders.js..." -ForegroundColor Yellow
...
module.exports = router;
"@ | Out-File -FilePath "$routePath/orders.js" -Encoding utf8

Write-Host "✅ orders.js fixed" -ForegroundColor Green

# ============================================
# 3. CUSTOMERS ROUTE
# ============================================
Write-Host "📝 Fixing customers.js..." -ForegroundColor Yellow
...
module.exports = router;
"@ | Out-File -FilePath "$routePath/customers.js" -Encoding utf8

Write-Host "✅ customers.js fixed" -ForegroundColor Green

# ============================================
# 4. SUPPLIERS ROUTE
# ============================================
Write-Host "📝 Fixing suppliers.js..." -ForegroundColor Yellow
...
module.exports = router;
"@ | Out-File -FilePath "$routePath/suppliers.js" -Encoding utf8

Write-Host "✅ suppliers.js fixed" -ForegroundColor Green

# ============================================
# 5. STOCK ROUTE
# ============================================
Write-Host "📝 Fixing stock.js..." -ForegroundColor Yellow
...
module.exports = router;
"@ | Out-File -FilePath "$routePath/stock.js" -Encoding utf8

Write-Host "✅ stock.js fixed" -ForegroundColor Green

# ============================================
# 6. USERS ROUTE
# ============================================
Write-Host "📝 Fixing users.js..." -ForegroundColor Yellow
...
module.exports = router;
"@ | Out-File -FilePath "$routePath/users.js" -Encoding utf8

Write-Host "✅ users.js fixed" -ForegroundColor Green

# ============================================
# 7. WARRANTY ROUTE
# ============================================
Write-Host "📝 Fixing warranties.js..." -ForegroundColor Yellow
...
module.exports = router;
"@ | Out-File -FilePath "$routePath/warranties.js" -Encoding utf8

Write-Host "✅ warranties.js fixed" -ForegroundColor Green

# ============================================
# 8. SERVICES ROUTE
# ============================================
Write-Host "📝 Fixing services.js..." -ForegroundColor Yellow
...
module.exports = router;
"@ | Out-File -FilePath "$routePath/services.js" -Encoding utf8

Write-Host "✅ services.js fixed" -ForegroundColor Green

# ============================================
# 9. ACTIVITY LOGS ROUTE
# ============================================
Write-Host "📝 Fixing activity-logs.js..." -ForegroundColor Yellow
...
module.exports = router;
"@ | Out-File -FilePath "$routePath/activity-logs.js" -Encoding utf8

Write-Host "✅ activity-logs.js fixed" -ForegroundColor Green
...
module.exports = router;
"@ | Out-File -FilePath "$routePath/dashboard.js" -Encoding utf8
...
Write-Host "✅ ALL ROUTES HAVE BEEN FIXED!" -ForegroundColor Green
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "📁 Files Updated:" -ForegroundColor Yellow
Write-Host "  - products.js"
Write-Host "  - orders.js"
Write-Host "  - customers.js"
Write-Host "  - suppliers.js"
Write-Host "  - stock.js"
Write-Host "  - users.js"
Write-Host "  - warranties.js"
Write-Host "  - services.js"
Write-Host "  - activity-logs.js"
Write-Host "  - dashboard.js"
Write-Host ""
Write-Host "🚀 Next steps:" -ForegroundColor Yellow
Write-Host "  1. git add backend/src/routes/"
Write-Host "  2. git commit -m 'FIX: Complete tenant isolation for ALL routes'"
Write-Host "  3. git push origin main"
Write-Host "  4. Wait for Render to deploy"
Write-Host "==========================================" -ForegroundColor Cyan